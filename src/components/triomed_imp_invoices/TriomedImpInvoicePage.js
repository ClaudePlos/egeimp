...
import styles from './TriomedImpInvoicePage.css';
...
class TriomedImpInvoicePage extends React.Component {
    constructor(props){
        super(props);
        this.state ={
            status:false
...
export class DataFromCSV extends React.Component {
    ...
    onClickUploadDataToEgeria(event) {
        ...
        this.props.actions.actUploadDataInvoicesFromSoftraToEgeria(dataJSON);
    }
...
export default connect(null, mapDispatchToProps)(DataFromCSV, TriomedImpInvoicePage);
